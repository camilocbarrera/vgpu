...
function createEffects(vgpu: VgpuApi, gpu: Gpu, label: string): Effects {
  return {
    bake: vgpu.effect(gpu, { shader: bakeWgsl, label: `${label}-bake` }),
    refine: vgpu.effect(gpu, { shader: refineWgsl, label: `${label}-refine` }),
    shade: vgpu.effect(gpu, { shader: shadeWgsl, label: `${label}-shade` }),
    bloomExtract: vgpu.effect(gpu, { shader: bloomWgsl, label: `${label}-bloom-extract` }),
    bloomBlurH0: vgpu.effect(gpu, { shader: bloomWgsl, label: `${label}-bloom-blur-h0` }),
    bloomBlurV0: vgpu.effect(gpu, { shader: bloomWgsl, label: `${label}-bloom-blur-v0` }),
    bloomDown1: vgpu.effect(gpu, { shader: bloomWgsl, label: `${label}-bloom-down-1` }),
    bloomBlurH1: vgpu.effect(gpu, { shader: bloomWgsl, label: `${label}-bloom-blur-h1` }),
    bloomBlurV1: vgpu.effect(gpu, { shader: bloomWgsl, label: `${label}-bloom-blur-v1` }),
    bloomDown2: vgpu.effect(gpu, { shader: bloomWgsl, label: `${label}-bloom-down-2` }),
    bloomBlurH2: vgpu.effect(gpu, { shader: bloomWgsl, label: `${label}-bloom-blur-h2` }),
    bloomBlurV2: vgpu.effect(gpu, { shader: bloomWgsl, label: `${label}-bloom-blur-v2` }),
    composite: vgpu.effect(gpu, { shader: compositeWgsl, label: `${label}-composite` }),
...
function setPostUniforms(effects: Effects, targets: Targets, settings: HeroSettings): void {
  ...
  effects.composite.set("composite", {
